...
@section('content')
    ...
    <div class="container-fluid patient-reg-advanced">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9">
                <div class="card shadow-lg border-0 mt-4 mb-5">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            <div class="rounded-circle accent-primary text-white d-flex align-items-center justify-content-center mr-3"
                        ...
                        <form method="POST" action="{{ route('patients.store') }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card mb-3 border-0 shadow-sm">
                                        <div class="card-body py-3">
                                            <h5 class="mb-3 text-primary-custom"><i class="fas fa-user mr-2"></i>Personal
                                                Information</h5>
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="mobile_phone">Mobile Number <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control form-control-lg @error('mobile_phone') is-invalid @enderror"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control form-control-lg" id="blood_group"
                                                    name="blood_group">
                                                    <option value="">Choose</option>
                                                    <option value="A+"
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-3 border-0 shadow-sm">
                                        <div class="card-body py-3">
                                            <h5 class="mb-3 text-primary-custom"><i class="fas fa-address-card mr-2"></i>Contact &
                                                Dates</h5>
                                            <div class="form-group mb-3">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 mb-3">
                                                    <label for="receiving_date">Receiving Date <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date"
                                                        class="form-control form-control-lg @error('receiving_date') is-invalid @enderror"
                                                ...
                                                <div class="form-group col-md-6 mb-3">
                                                    <label for="reporting_date">Reporting Date <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date"
                                                        class="form-control form-control-lg @error('reporting_date') is-invalid @enderror"
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <div class="card border-0 shadow-sm mb-3">
                                        <div class="card-body py-3">
                                            <h5 class="mb-3 text-primary-custom"><i class="fas fa-vials mr-2"></i>Select Tests
                                                ...
                                                <div class="row">
                                                    @foreach ($testCategories as $category)
                                                        <div class="col-md-4 col-sm-6 mb-2">
                                                            <div
                                                                class="custom-control custom-checkbox custom-checkbox-adv">
                                                                <input type="checkbox"
                                                                ...
                                                                <label class="custom-control-label font-weight-bold"
                                                                    ...
                                                                    <i
                                                                        class="fas fa-flask text-info mr-1"></i>{{ $category->cat_name }}
                                                                    @if ($category->price)
                                                                        <small
                                                                            class="text-muted">({{ number_format($category->price, 2) }}
                                                                            PKR)</small>
                                                                    @endif
                                                                </label>
                                                            </div>
                                            ...
                                            @else
                                                <div class="alert alert-warning">
                                                    <i class="fas fa-exclamation-triangle"></i> No test categories
                                                    available. Please add test categories first from the <a
                                                        href="{{ route('labtest.index') }}">Lab Test Category</a> section.
                                                </div>
                                            @endif
                ...
                <a href="{{ route('patients.list') }}" class="btn btn-outline-secondary btn-lg mr-2"><i
                    class="fas fa-arrow-left mr-1"></i>Cancel</a>
                <button type="submit" class="btn btn-primary-custom btn-lg" id="submitBtn"><i
                    class="fas fa-user-plus mr-1"></i>Register Patient</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <style>
        ...
        /* Replace gradient with primary palette color */
