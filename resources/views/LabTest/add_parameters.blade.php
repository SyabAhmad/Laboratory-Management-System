    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0 rounded-3 bg-cards">
            <div class="card-header bg-surface border-0 py-3 d-flex align-items-center justify-content-between"
                style="background-color: #8d2d36; color: white;">
                <h4 class="mb-0">
                    ...
                    <div id="parameter-container">
                        <div class="row parameter-row mb-3 g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="parameter_name[]" class="form-control"
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="reference_range[]" class="form-control"
                                    placeholder="Reference Range (e.g., 5–20)">
                            </div>
                                    ...
                                    <tr data-param-id="{{ $param->id }}">
                                        ...
                                        <td class="param-field-type">
                                            @switch($param->field_type ?? 'text')
                                                ...
                                                @default
                                                    <span
                                                        class="badge badge-secondary">{{ ucfirst($param->field_type ?? 'text') }}</span>
                                            @endswitch
                                        </td>
                                        ...
                                        <td class="text-end param-actions">
                                            ...
                                            <form action="{{ route('labtest.parameters.destroy', $param->id) }}"
                                                method="POST"
    ...
    <script>
        ...
        (function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch(form.action, {
                    ...
                    if (btn) {
                        btn.disabled = false;
                        btn.innerHTML = '<i class="bi bi-check-circle me-1"></i> Save Parameters';
                    }
                });
            });
        })();
        ...
        (function() {
            ...
            table.addEventListener('click', function(e) {
                ...
                nameCell.innerHTML =
                    `<input type="text" class="form-control form-control-sm edit-name" value="${escapeHtml(currentName)}">`;
            ...
            `;
                ...
                rangeCell.innerHTML =
                    `<input type="text" class="form-control form-control-sm edit-range" value="${escapeHtml(currentRange)}">`;
                ...
                if (saveBtn) {
                    ...
                    fetch("{{ url('/labtest/parameters') }}/" + id, {
                        ...
                        if (data && data.success) {
                            // update row display
                            row.querySelector('.param-name').textContent = data.param
                                .parameter_name;
                            ...
                            switch (fieldType) {
                                ...
                                case 'textarea':
                                    ...
                                    break;
                                default:
                                    fieldTypeBadge = '<span class="badge badge-secondary">' +
                                        fieldType + '</span>';
                            }
