    ...
    */
        (App.prototype._resetSidebarScroll = function () {
            ...
            (App.prototype.initMenu = function () {
                ...
                // Left menu collapse (open button in topbar)
                $(".button-menu-mobile").on("click", function (event) {
                    ...
                    // Toggle open class on button for icon change
                ...
                $(".sidebar-close-btn").on("click", function (event) {
                    event.preventDefault();
                    if ($this.$window.width() >= 768) {
                    ...
                    // Remove open class from hamburger button when closing sidebar
